  ...
  const roadmapItems = [
    {
      ...
      description: "Tréneri si budú môcť pridať paywall pre prémiový obsah určený výhradne pre svojich predplatiteľov.",
      icon: (
    ...
    },
    {
      ...
      description: "Pozvite nových trénerov a za každého aktívneho člena získajte výhody alebo si znížte percentuálnu províziu, ktorú odvádzate platforme.",
      icon: (
        <svg className="w-6 h-6 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "3. Interaktívna mapa",
      description: "Používatelia uvidia všetkých zaregistrovaných trénerov vo svojom okolí na interaktívnej mape s možnosťou rozšíreného filtrovania a vyhľadávania.",
      icon: (
        <svg className="w-6 h-6 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "4. Balíčky služieb",
      description: "Vytvárajte výhodné balíčky a akcie na svoje tréningy a služby, čím motivujete klientov k dlhodobej spolupráci a zefektívnite si kalendár.",
      icon: (
        <svg className="w-6 h-6 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "5. Rozšírenie pre špecialistov",
      description: "Plánujeme otvoriť platformu aj pre ďalších odborníkov, ako sú výživoví poradcovia, fyzioterapeuti a iní špecialisti v oblasti zdravia.",
      icon: (
        <svg className="w-6 h-6 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "6. Expanzia do Českej republiky",
      description: "Naším cieľom je rozšíriť pôsobnosť Fitbase aj na český trh a vybudovať tak silnú komunitu trénerov v oboch krajinách.",
      icon: (
        <svg className="w-6 h-6 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
